...
*/
  ...
  G4double seperatorX {27};   //defining x, y, z lengths of the seperator sheet which all the components arr attatched to
  G4double seperatorY {59};  
